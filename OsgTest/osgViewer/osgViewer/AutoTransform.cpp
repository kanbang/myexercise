...
osg::Geometry* CreateMarker()
{
    ...
    pVerts->push_back( osg::Vec3( -10, 0, 0 ) );
    pVerts->push_back( osg::Vec3( 0, 10, 0 ) );
    pVerts->push_back( osg::Vec3( 10, 0, 0 ) );
    pVerts->push_back( osg::Vec3( 0, -10, 0 ) );
...
osg::Node* CreateAutoTransform( float x, float y, float z, float scale )
{
    ...
    //pAutoTransform->setPivotPoint(osg::Vec3( x, y, z ) * scale);
    pAutoTransform->addChild( CreateMarkerNode( 20 ) );
