...
AC_IMPLEMENT_EXTENSION_MODULE( DrawFFCCmdDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE DrawFFCCmdExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        DrawFFCCmdDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        DrawFFCCmdDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
