...
AC_IMPLEMENT_EXTENSION_MODULE( ARX_FFC_UIDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE ARX_FFC_UIExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        ARX_FFC_UIDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        ARX_FFC_UIDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
