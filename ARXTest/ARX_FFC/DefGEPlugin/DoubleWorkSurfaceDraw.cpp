...
void DoubleWorkSurfaceDraw::setAllExtraParamsToDefault()
{
    ...
    // 箭头参数与 -- 工作面长度200m
    m_trunkWidth = FFC_WS_TRUNK_WIDTH * FFC_WS_COEFF;
    m_trunkLength = FFC_WS_TRUNK_LENGTH * FFC_WS_COEFF;
    m_arrowWidth = FFC_WS_ARROW_WIDTH * FFC_WS_COEFF;
    m_arrowLength = FFC_WS_ARROW_LENGTH * FFC_WS_COEFF;
    //m_clockWise = false;
}
...
void DoubleWorkSurfaceDraw::readKeyParam( DrawParamReader& reader )
{
    DoubleTunnelDraw::readKeyParam( reader );
    reader.readBoolean( m_clockWise );
}

void DoubleWorkSurfaceDraw::writeKeyParam( DrawParamWriter& writer )
{
    DoubleTunnelDraw::writeKeyParam( writer );
...
void DoubleWorkSurfaceDraw::reverse()
{
