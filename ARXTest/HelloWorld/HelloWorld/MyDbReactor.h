...
//-----------------------------------------------------------------------------
//----- MyDbReactor.h : Declaration of the MyDbReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ MyDbReactor : public AcDbDatabaseReactor {
...
public:
	MyDbReactor (AcDbDatabase *pDb =NULL) ;
	virtual ~MyDbReactor () ;
...
#ifdef HELLOWORLD_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(MyDbReactor)
#endif
