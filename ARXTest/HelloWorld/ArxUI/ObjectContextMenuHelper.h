...
/*
 ...
 // 4) 如果要卸载菜单，请调用UnRegAllObjectContextMenu()方法
...
public:
	// 注册对象菜单
	static void RegObjectContextMenu(ObjectContextMenu* pObjMenu, const void *appId);
	// 删除所有的对象菜单
	static void UnRegAllObjectContextMenu();
};
