...
AC_IMPLEMENT_EXTENSION_MODULE( ArxLoaderDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE ArxLoaderExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        ArxLoaderDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        ArxLoaderDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
