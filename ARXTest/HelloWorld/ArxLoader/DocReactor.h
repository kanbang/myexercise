...
//-----------------------------------------------------------------------------
//----- DocReactor.h : Declaration of the DocReactor
//-----------------------------------------------------------------------------
#pragma once

#ifdef ARXLOADER_MODULE
...
class /*DLLIMPEXP*/ DocReactor : public AcApDocManagerReactor {

public:
	ACRX_DECLARE_MEMBERS(DocReactor) ;
...
public:
	DocReactor (const bool autoInitAndRelease =true) ;
	virtual ~DocReactor () ;
...
#ifdef ARXLOADER_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(DocReactor)
#endif
