...
void AirFlowCaculate::tws_afc_test( TableCreator* pTableCreator, DataWriter* pDataWriter )
{
    ...
    for( int i = 0; i < len; i++ )
    {
        ...
        tws_afc.initLocalFan_AFCStrategy( pTws->area, pTws->fanNum, ( pTws->tunnelMaterial == ROCK ) ); // 1表示岩巷
