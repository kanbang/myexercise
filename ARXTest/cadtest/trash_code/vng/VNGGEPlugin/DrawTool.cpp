...
void DrawEllipse( AcGiWorldDraw* mode, const AcGePoint3d& insertPt, double width, double height, bool fill )
{
    AcGiSubEntityTraits& traits = mode->subEntityTraits();
    AcGiFillType ft = traits.fillType();
    traits.setFillType( fill ? kAcGiFillAlways : kAcGiFillNever );
    ...
    // 绘制椭圆
    AcDbEllipse ellipse( insertPt, AcGeVector3d::kZAxis, v, c );
...
void DrawArc( AcGiWorldDraw* mode, const AcGePoint3d& insertPt, double radius, double startAngle, double sweepAngle, bool fill )
{
    AcGiSubEntityTraits& traits = mode->subEntityTraits();
    AcGiFillType ft = traits.fillType();
    traits.setFillType( fill ? kAcGiFillAlways : kAcGiFillNever );
...
void DrawMText( AcGiWorldDraw* mode, const AcGePoint3d& pt, double angle, const CString& str, double height, AcDbMText::AttachmentPoint ap, bool bgfill )
{
    //acutPrintf(str);
...
double CacArcAngle( const AcGePoint3d& spt, const AcGePoint3d& ept, const AcGePoint3d& pt, double L )
{
    AcGeCircArc3d arc( spt, pt, ept );
