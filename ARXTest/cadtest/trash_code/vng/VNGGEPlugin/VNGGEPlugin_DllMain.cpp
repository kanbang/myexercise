...
AC_IMPLEMENT_EXTENSION_MODULE( VNGGEPluginDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE VNGGEPluginExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        VNGGEPluginDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        VNGGEPluginDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
