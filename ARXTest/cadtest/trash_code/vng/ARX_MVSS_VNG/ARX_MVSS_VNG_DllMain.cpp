...
AC_IMPLEMENT_EXTENSION_MODULE( ARX_MVSS_VNGDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE ARX_MVSS_VNGExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        ARX_MVSS_VNGDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        ARX_MVSS_VNGDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
