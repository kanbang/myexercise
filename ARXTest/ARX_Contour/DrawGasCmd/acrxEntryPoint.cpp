...
public:
    ...
    static void JL_DrawMineBoundary()
    {
        DrawCmd::DrawMineBoundary();
    }

    static void GAS_ShowDataListDlg()
    {
...
ACED_ARXCOMMAND_ENTRY_AUTO( CDrawGasCmdApp, JL, _DrawMineBoundary, DrawMineBoundary, ACRX_CMD_TRANSPARENT, NULL )
ACED_ARXCOMMAND_ENTRY_AUTO( CDrawGasCmdApp, JL, _SplitGoaf, SplitGoaf, ACRX_CMD_TRANSPARENT, NULL )
ACED_ARXCOMMAND_ENTRY_AUTO( CDrawGasCmdApp, JL, _RemoveGoafPoint, RemoveGoafPoint, ACRX_CMD_TRANSPARENT, NULL )
...
ACED_ARXCOMMAND_ENTRY_AUTO( CDrawGasCmdApp, GAS, _ShowDataListDlg, ShowDataListDlg, ACRX_CMD_TRANSPARENT, NULL )
