...
bool FieldHelper::GetObjectListTypeName( const CString& type, const CString& field, CString& name )
{
    FieldInfo info;
    FieldInfoHelper::ReadFieldInfo( type, field, info );
    if( !info.isObjectListType() ) return false;
