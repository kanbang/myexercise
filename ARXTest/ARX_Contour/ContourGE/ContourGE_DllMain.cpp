...
AC_IMPLEMENT_EXTENSION_MODULE( ContourGEDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE ContourGEExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        ContourGEDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        ContourGEDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
