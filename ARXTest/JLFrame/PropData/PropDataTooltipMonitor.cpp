...
#include "../FieldInfo/FieldInfoHelper.h"
...
PropDataTooltipMonitor::PropDataTooltipMonitor ( AcApDocument* pDoc ) : AcEdInputPointMonitor(), mpDocument( pDoc )
{
    if ( pDoc )
    {
...
PropDataTooltipMonitor::~PropDataTooltipMonitor ()
{
    Detach () ;
}

void PropDataTooltipMonitor::Attach ( AcApDocument* pDoc )
{
    Detach () ;
    if ( mpDocument == NULL )
    {
...
void PropDataTooltipMonitor::Detach ()
{
    if ( mpDocument )
    {
...
AcApDocument* PropDataTooltipMonitor::Subject () const
{
    return ( mpDocument ) ;
}

bool PropDataTooltipMonitor::IsAttached () const
{
    return ( mpDocument != NULL ) ;
}

bool PropDataTooltipMonitor::excludeFromOsnapCalculation (
...
Acad::ErrorStatus PropDataTooltipMonitor::monitorInputPoint (
