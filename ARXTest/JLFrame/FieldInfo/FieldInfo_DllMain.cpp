...
AC_IMPLEMENT_EXTENSION_MODULE( FieldInfoDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE FieldInfoExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        FieldInfoDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        FieldInfoDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
