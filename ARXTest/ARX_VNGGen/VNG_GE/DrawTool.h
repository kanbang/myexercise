...
extern void DrawEllipse(AcGiWorldDraw *mode, const AcGePoint3d& insertPt, double width, double height, bool fill);
...
extern void DrawMText(AcGiWorldDraw *mode, const AcGePoint3d& pt, double angle, const CString& str, double height, AcDbMText::AttachmentPoint ap=AcDbMText::kMiddleCenter, bool bgfill = false);
...
extern double CacArcAngle(const AcGePoint3d& spt, const AcGePoint3d& ept, const AcGePoint3d& pt, double L);