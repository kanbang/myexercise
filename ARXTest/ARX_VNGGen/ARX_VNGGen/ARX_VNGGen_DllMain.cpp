...
AC_IMPLEMENT_EXTENSION_MODULE( ARX_VNGGenDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE ARX_VNGGenExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        ARX_VNGGenDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        ARX_VNGGenDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
