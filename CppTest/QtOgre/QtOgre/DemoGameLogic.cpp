...
namespace QtOgre
{
    ...
    void DemoGameLogic::initialise( void )
    {
        ...
        Ogre::String aa = "C:/develop/Test/AllCodes/CppTest/QtOgre/QtOgre";
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation( aa + "/media/models", "FileSystem" );
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation( aa + "/media/textures", "FileSystem" );
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation( aa + "/media/materials", "FileSystem" );
        ...
        mSceneManager->setAmbientLight( Ogre::ColourValue( 1.0, 1.0, 1.0 ) );
        ...
        Ogre::Entity* ogreHead2 = mSceneManager->createEntity( "Head2", "ogrehead.mesh" );
        Ogre::SceneNode* headNode2 = mSceneManager->getRootSceneNode()->createChildSceneNode( "HeadNode2", Ogre::Vector3( 100, 0, 0 ) );
